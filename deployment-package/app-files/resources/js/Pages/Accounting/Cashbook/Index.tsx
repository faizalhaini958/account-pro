...
export default function Index({ accounts, filters, ledger }: Props) {
    const [params, setParams] = useState({
        account_id: filters.account_id || (accounts.length > 0 ? accounts[0].id.toString() : ""),
        start_date: filters.start_date,
        end_date: filters.end_date,
    })

    const handleSearch = () => {
        router.get(route('accounting.cashbook'), params as any, { preserveState: true })
    }
    ...
    return (
        <DashboardLayout header="Cashbook">
            <Head title="Cashbook" />
            ...
            <div className="flex-1 space-y-4 p-8 pt-6">
                ...
                <Card className="print:hidden">
                    <CardHeader className="pb-3">
                        ...
                        <CardDescription>View receipts and payments for your cash and bank accounts.</CardDescription>
                    </CardHeader>
                    {/* ... */}
                    <CardContent>
                ...
                {ledger ? (
                                ...
                                <Table>
                                    <TableHeader>
                                        <TableRow>
                                            ...
                                            <TableHead className="text-right w-[120px]">Receipts (Dr)</TableHead>
                                            <TableHead className="text-right w-[120px]">Payments (Cr)</TableHead>
                    ...
                    <div className="text-center py-12 text-muted-foreground bg-muted/20 rounded-xl border border-dashed">
                        {accounts.length === 0 ? "No Cash or Bank accounts found." : "Select an account to view the Cashbook."}
                    </div>
                )}
            </div>
            <style>{`
